...
if (get_option('linkedin_plugin_do_activation_redirect', false)) {
	...
	$url = 'https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id='.$client_id.'&redirect_uri='.$url_redirect.'&state='.$state.'&scope=r_fullprofile r_emailaddress';
	 ...
	 if (!current_user_can('manage_options')){
        wp_die( _e('You are not authorized to view this page.') );
			        ...
			        <form name="form1" method="post" action="">
					            ...
					            <p>
					            	<h4><?php _e('Important: Make sure you have entered as authorized Url redirect, the following URI: '); echo $url_redirect; ?></h4> 
					            </p>
					            <p>
					            ...
					            <p>
					                ...
					                <input type="checkbox" id="<?php echo $data_field_name_register; ?>" name="<?php echo $data_field_name_register; ?>" <?php if($opt_val_register) echo 'checked="checked"'; ?> /></label>
